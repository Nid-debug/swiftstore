        ...
        <div className="grid grid-cols-1 md:grid-cols-2 lg:grid-cols-4 gap-12 mb-12">
          <div className="space-y-4">
            ...
            <p className="text-slate-500 text-sm leading-relaxed">
              High-quality products delivered to your doorstep. Experience the
              seamless way of modern shopping.
            </p>
          ...
          <div>
            ...
            <form className="flex flex-col gap-2">
              ...
              />
              <button className="w-full bg-slate-900 text-white py-2 rounded-lg text-sm font-medium hover:bg-slate-800 transition-colors hover:cursor-pointer">
                Subscribe
              </button>
            </form>
          </div>
